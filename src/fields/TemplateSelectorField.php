...
namespace swishdigital\templateselector\fields;

use swishdigital\templateselector\TemplateSelector;
use swishdigital\templateselector\assetbundles\templateselectorfieldfield\TemplateSelectorFieldFieldAsset;
...
class TemplateSelectorField extends Field
{
    ...
    {
        return Craft::t('template-selector', 'Template Selector');
    }
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'template-selector/_components/fields/TemplateSelectorField_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml ($value, ElementInterface $element = null): string
    {
        ...
        if ( !file_exists($templatesPath) ) {
            throw new \InvalidArgumentException(Craft::t('template-selector', 'Template Selector Folder doesn\'t exist: ') . $templatesPath);
        }
        ...
        $placeholder[] = Craft::t('template-selector', 'No template selected');
        ...
        return Craft::$app->getView()->renderTemplate(
            'template-selector/_components/fields/TemplateSelectorField_input',
            [
                'name'         => $this->handle,
                'value'        => $value,
                'field'        => $this,
